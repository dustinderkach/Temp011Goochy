...
import { handler } from "../../../src/services/temp011Goochy/handlerTemp011Goochy";
...
describe("Temp011Goochy handler test suite", () => {
	test("Returns temp011Goochy from dynamoDb", async () => {
